...
- [ ] Tako identifies Netplan ownership and never generically overwrites unmanaged YAML.
- [ ] Rollback verifies runtime and on-disk state before reporting recovery.
