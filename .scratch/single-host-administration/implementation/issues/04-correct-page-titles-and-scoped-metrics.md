# 04 — Correct page titles and scoped metrics

**What to build:** One current-page header title, no duplicate page breadcrumb, storage-only directional charts, and network-only directional charts.
