# 49 — Correlate incidents diagnostics and notifications

**What to build:** Incident timeline, bounded sos reports, built-in notifications, acknowledgement/mute/resolution, configured-certificate monitoring, and final packaged VM matrix.
